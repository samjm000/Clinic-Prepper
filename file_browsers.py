...
def get_excel_file(self):
    ...
    self.upload_label.config(text=f"Selected input: .../{os.path.basename(self.input_excel_file)}")
...
def get_source_folder(self):
        ...
        if folder_path:
            self.selected_folder_label.config(text=f"Selected folder: .../{os.path.basename(folder_path)}")
